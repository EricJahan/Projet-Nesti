...
--
-- Hôte : localhost:8889
-- Généré le :  jeu. 21 mars 2019 à 12:23
...
(1, 'Crevettes sautées curry coco', 'Etape 1 : \r\nDécortiquer et laver les crevettes.\r\nEtape 2 : \r\nFaire frire les crevettes dans une poêle avec une cuillère d\'huile et deux gousse d\'ail.\r\nEtape 3 : \r\nDélayer de la pâte de curry (une cuillère à soupe) et un fond d\'eau dans un verre. L\'ajouter dans la poêle avec les crevettes.\r\nEtape 4 : \r\nAjouter 50cl de crème de coco dans la préparation.\r\nEtape 5 : \r\nAssaisonnez d\'une pincée de sel, de poivre, de curry en poudre et de curcuma.\r\nEtape 6 : \r\nLaissez refroidir une demi-heure / une heure permet aux crevettes de prendre le goût de la coco.\r\nEtape7 : \r\nRéchauffer au moment du repas.\r\n\r\nNote : Servir avec du riz ou du vermicelle chinois.\r\nNote : Vous pouvez ajouter de la citronnelle selon les goûts.', '4', '1 heure'),
